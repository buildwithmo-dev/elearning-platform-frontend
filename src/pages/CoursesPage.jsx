...
export default function CoursesPage() {
  ...
  return (
  /* Increased pt-28 to ensure the header doesn't hide behind the fixed Nav */
  <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pt-28 px-6 lg:px-12">
    ...
    {/* CHANGED: Switched from grid to flex to prevent overlapping */}
    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8">

      {/* SIDEBAR - Added fixed width (w-72) and flex-shrink-0 */}
      <aside className="w-full lg:w-72 flex-shrink-0">
        <div className="backdrop-blur-xl bg-white/70 border border-white/40 rounded-3xl p-5 h-fit sticky top-28 shadow-xl z-10">
      ...
      {/* COURSE GRID - Added flex-1 to take up remaining space */}
